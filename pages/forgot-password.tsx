...
const ForgotPassword: NextPage = () => {
  return (
    <div className="w-full relative [background:linear-gradient(90deg,_rgba(255,_222,_233,_0.12),_rgba(181,_255,_252,_0.12)),_#fff] overflow-hidden flex flex-row items-start justify-start pt-[108px] px-[412px] pb-[238px] box-border leading-[normal] tracking-[normal] text-left text-base text-white font-h3 mq450:pl-5 mq450:pr-5 mq450:box-border mq675:pl-[206px] mq675:pr-[206px] mq675:box-border">
      ...
      <div className="flex-1 shadow-[6px_5px_20px_10px_rgba(0,_0,_0,_0.05)] rounded-number bg-white flex flex-row items-start justify-start p-8 box-border max-w-full mq450:pt-[21px] mq450:pb-[21px] mq450:box-border">
        <Content />
      </div>
    </div>
  );
